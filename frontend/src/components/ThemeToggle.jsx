...
const ThemeToggle = () => {
  ...
  return (
    <motion.button
      onClick={toggleTheme}
      className="h-9 w-9 rounded-full flex items-center justify-center bg-gray-200 dark:bg-gray-700/50 text-gray-800 dark:text-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
